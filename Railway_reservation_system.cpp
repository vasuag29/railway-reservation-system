...
/////////////////////////////////////////////////////////////////////////////////
char* validation_character1(char*m)										//Validation for phone number
{
	int i,flag,l;
...
////////////////////////////////////////////////////////////////////////////////
char* validation_character2(char*a)                                              //validation function for name
{
int flag;
...
////////////////////////////////////////////////////////////////////////////////
int admin_password()                                                            //admin password check
{
char pwd[50],def[]="admin";
int i=0,mycheck,a=0;
cout<<"\n ENTER ADMIN PASSWORD :  ";
for(i=0;;i++)                                            //loop to put '*' for the password
{
pwd[i]=getch();
a=pwd[i];
if(a==13)                                                //13 is the ASCII code for enter key
{                                                        //if enter is pressed password is fully entered and goes to the next
pwd[i]='\0';                                             //puts a null character at the end of the password string
break;
}
else if(a==8)                                            //8 is the ASCII code for backspace
{
if(i>0)
{
...
putch('*');                                              //prints'*'after every character is typed
}
cout<<endl;
...
////////////////////////////////////////////////////////////////////////////////
int check(char a[5],char b[5])                                                  //for admin password check 
{
	 int i;
	 for(i=0;i<5;i++)
	 {
...
{  int i;
 ...
 cout<< "Time: " << Hour << ":" << Min << ":" << Sec <<"                                       DSA  PROJECT ";
 cout<<"\n";
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
int user::bnumber()                                                       // generates a random no.
{                                                                               //random no. is assigned as sub no
int i,randnum;
unsigned int s;
time_t t;
s=(unsigned)time(&t);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void user::search_bid()                                                 // subscriber search using subscriber no.
{
 int sno;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////	
int user::bookticket(char *trainno,char *frm,char *dest,int ecost,int bcost,int type)                                                      //get subscriber's details
{ 
int flag2=0;
cout<<"\n"<<trainno;
...
ttckt=charge;
 cout<<"mycheck : "<<mob<<"\t"<<trno;
  ...
  cout<<"\n YOU CAN MAIL YOUR SUGGESTIONS AND FEEDBACK TO US ON\n";
  cout<<"                dsaproject_vit@gmail.com             \n";
  cout<<"\n THANK YOU \n";
